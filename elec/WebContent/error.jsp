					...
					<table border="0" width="60%" id="table2" cellspacing="0"
						...
						<tr>
							<td width="49" height="45"><img border="0"
								...
								width="185" height="180"></td>
							<td style="word-break: break-all" align="center"><font
								face="黑体" size="6" color="red"> <b><s:fielderror />${errorMsg }！<br>系统将在5秒中内跳转到登录页面
										<br> </b><br>
							</font></td>
						</tr>
						<tr>
							...
							<td style="word-break: break-all" align="center"><font
								face="黑体" size="3" color="red">
									<div id="timer"
										style="color: #999; font-size: 20pt; text-align: center"></div>
							</font></td>
						</tr>
					</table>
				</td>
...
<script>
	...
	function showTimer() {
		if (i == 0) {//如果秒数为0的话,清除t,防止一直调用函数,对于反应慢的机器可能实现不了跳转到的效果，所以要清除掉 setInterval()
			...
			//window.open("${pageContext.request.contextPath }/WEB-INF/pages/menu/index.jsp", "_self");
