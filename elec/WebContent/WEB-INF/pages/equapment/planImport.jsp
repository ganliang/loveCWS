...
<body onload="successInit()">
	<form name="importForm" method="post"
		action="equapment/elecDevPlanAction_importData.do"
		...
		<table border="0" width="100%" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<td width="83%" align="left"><input type="file" name="files"
			...
			<tr>
				<td align="center" colspan=4><input type="submit" name="import"
					...
					<INPUT type="button" name="Reset1" id="save" value="关闭" ID="Reset1"
