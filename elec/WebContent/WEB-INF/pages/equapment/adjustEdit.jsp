...
function check(){
	 ...
	 if(window.opener)
	{
		document.Form1.action="equapment/elecAdjustAction_update.do";
							...
							<tbody>
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff" width="224"><input
										...
										<input name="adjustPeriod" type="text" id="TB_timeW" size="19"
								...
								<tr>
									...
									<td class="ta_01" bgColor="#ffffff" width="224"><s:select
											...
											disabled="true" cssClass="bg" listKey="ddlCode"
