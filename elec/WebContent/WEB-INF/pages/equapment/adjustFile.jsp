...
<script language="javascript">
	...
	function getUrl(flag, fileUploadID) {

		strUrl = strUrl + "?fileUploadID=" + fileUploadID;
...
<body>
	...
	<br>
	<form name="Form1"
		action="station/elecFileUploadAction_adjustUpload.do" method="post"
		enctype="multipart/form-data">
		<s:hidden name="adjustID" value="%{#request.adjust.adjustID}" />
							...
							<s:iterator value="#request.fileUploadList">
								<tr onMouseOver="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="left" width="71%">
										...
										onclick="getUrl('station/elecFileUploadAction_adjustDownload.do', '<s:property value="fileUploadID"/>')">
											<s:property value="fileFileName" />
									</td>
									<td align="center"><a
										href="atation/elecFileUploadAction_adjustDelete.do?fileUploadID=<s:property value="fileUploadID"/>"
