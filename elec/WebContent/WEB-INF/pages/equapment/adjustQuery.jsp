			...
			<tr>
				<td class="ta_01" align="center" colspan=8 bgcolor="#f5fafe">
					<table id="tblSubEngin" cellspacing="0" cellpadding="1" rules="all"
						...
						<s:iterator value="#request.adjustList">
							<tr>
								<td style="CURSOR: hand;" align=center width=15%><a
									href="javascript:;"
									onClick="ViewDetail('equapment/elecEquapmentAction_view.do?equapmentID=<s:property value='adjustID' />')"
								...
								<td style="CURSOR: hand;" align=center width=8%><a
									href="javascript:;"
									onClick="EditDetail('equapment/elecAdjustAction_edit.do?adjustID=<s:property value='adjustID' />')"
									class="cl_01">编辑</a></td>
							</tr>
						</s:iterator>
					</table>
