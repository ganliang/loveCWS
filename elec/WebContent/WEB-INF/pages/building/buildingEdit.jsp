...
<Script language="javascript">
	function check_null() {
		...
		document.Form1.action = "building/elecBuildingAction_update.do";
...
<body>
	<form name="Form1" method="post" id="Form1">
		<s:hidden name="buildingID" value="%{#request.build.buildingID}" />
		<br>
		<table cellSpacing="1" cellPadding="5" width="580" align="center"
			...
			<tr>
				...
				<td width="85%" class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						cssStyle="WIDTH: 92%" rows="4" cols="52"></s:textarea></td>
			</tr>
