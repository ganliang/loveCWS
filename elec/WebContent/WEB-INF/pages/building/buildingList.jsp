				...
				<table cellspacing="0" cellpadding="1" rules="all"
					...
					<s:iterator value="#request.buildList">
						<tr onmouseover="this.style.backgroundColor = 'white'"
							...
							<td align="center" width="6%"><s:property value="buildingID" /></td>
							...
							<td align="center" width="7%"><s:property value="buildLayer" /></td>
							<td align="center" width="10%"><s:property
									value="buildExpense" /></td>
							<td align="center" width="11%"><s:property value="buildArea" /></td>
