...
<body>
		<form name="Form1" action="workflow/elecApplicationTemplateAction_update.do" method="post" enctype="multipart/form-data">
			...
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
				...
				<input type="hidden" name="path" value="<s:property value="#request.applicationTemplate.path"/>"/>
				<tr>
				...
				<tr>
			        ...
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        	<input type="text" name="name" size="20" value="<s:property value="#request.applicationTemplate.name"/>" id="name"/>
			        </td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">流程定义的Key值：<font color="#FF0000">*</font></td>
			        <td class="ta_01" bgColor="#ffffff" colspan="3">
			        <s:if test="#request.processDefinitionList!=null&&#request.processDefinitionList.size()>0">
