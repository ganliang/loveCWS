  ...
  function downcol() {
   ...
   function setValue(){
     ...
     function checksubmit(){
       ...
       document.Form1.action="${pageContext.request.contextPath }/system/elecExportFieldsAction_saveSetExportExcel.do";
           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                   ...
                   <s:select list="#request.map" name="colname2" id="colname2"
                   			 size="15" multiple="true"
                   			 cssStyle="width:200px" ondblclick="JavaScript:Remove('colname1','colname2','colname')">
                   </s:select>
                   </td>  
                  ...
                  <tr><td width="73">
                  	   <INPUT type="hidden"  name="belongTo"  id="belongTo"  value="<s:property value="belongTo"/>">
