						...
						<td height="99" width="27%">
							<table border="0" width="70%" id="table4">
								<tr>
									...
									<td>
									<s:textfield name="name" cssStyle="width:125px" size="20" maxlength="25"  value="%{#request.name}"></s:textfield>
								</tr>
								<tr>
									<td width="100"><img border="0" src="${pageContext.request.contextPath}/images/mima.jpg" width="75" height="20"></td>
									<td>
									<s:password name="password" cssStyle="width: 125px" size="20" maxlength="25" value="%{#request.password}" showPassword="true"></s:password>
									</td>
								</tr>
								<tr>
									...
									<td>
										<table>
											<tr>
												<td>
												    <s:textfield name="checkNumber" id="checkNumber" maxlength="4" size="7"  ></s:textfield>
												</td>
												<td>
								...
								<tr>
									...
									<td>
										<input type="checkbox" name="remeberMe" id="remeberMe" ${checked } />
									</td>
								</tr>
								<tr>
									<td width="100"></td>
