...
<script language="javascript">
	...
	function addFileList() {
		...
		if (overWriteFile("filesTbl", "filesTb2")) {
			document.Form1.action = "station/elecFileUploadAction_upload.do";
			document.Form1.submit();
		} else
			return false;
	...
	function getUrl(fileUploadID) {
		var strUrl = "elecFileUploadAction_view.do?fileUploadID="+ fileUploadID;
...
<body onload="init()">
	...
	<form name="Form1" method="post" enctype="multipart/form-data">
		<s:hidden name="elecBug.bugID" value="%{#request.bug.bugID}" />
			...
			<TBODY>
				...
				<tr>
					...
					<TD class="DropShadow" align="left"
						background="../images/cotNavGround.gif" width=100>添加上传文件列表</TD>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td class="ta_01" align="center" width="60%"
									background="../images/tablehead.jpg" height=20>选择待上传文件</td>
								<td class="ta_01" align="center" width="20%"
				...
				<tr>
					<TD align="center" background="../images/cotNavGround.gif"><img
						src="../images/yin.gif" width="15"></TD>
					<TD class="DropShadow" align="left"
						background="../images/cotNavGround.gif" width=100>已上传文件列表</TD>
					<TD width="80%"></TD>
				</tr>
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>
							...
							<s:iterator value="#request.fileUploadList" status="item">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 21px"><a
										href="station/elecFileUploadAction_delete.do?fileUploadID=<s:property
											value='fileUploadID' />"
