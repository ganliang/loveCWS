...
<script language="javascript">
	...
	function upload(fn, jctId) {
		var str = "siteStateFile.jsp?belongTo=" + fn + "&jctId=" + jctId
				+ "&projid=bugid";
		...
		<table cellspacing="1" cellpadding="5" width="580" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><s:select
						...
						value="<s:property value='#request.bug.elecStation.jctID'/>"></s:select>
					<font color="#FF0000">*</font></td>
				<td width="18%" align="center" bgcolor="#f5fafe" class="ta_01">站点名称：</td>
				<td class="ta_01" bgcolor="#ffffff"><s:select
						list="#request.stationList" name="elecStation.stationID"
						id="stationName" cssStyle="width: 155px" listKey="stationID"
						listValue="stationName"
						value="<s:property value='#request.bug.elecStation.stationName'/>"></s:select>
					<font color="#FF0000">*</font></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><s:select
						...
						cssStyle="width: 155px" listKey="ddlCode" listValue="ddlName"
						value="<s:property value='#request.bug.bugType'/>"></s:select> <font
					color="#FF0000">*</font></td>
				<td height="22" align="center" bgColor="#f5fafe" class="ta_01">站点代号：</td>
				<td class="ta_01" bgColor="#ffffff"><input
					name="elecStation.stationCode" type="text" id="stationCode" size=20
					readonly
					value="<s:property value='#request.bug.elecStation.stationCode'/>"></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><input name="produceHome"
					...
					size=20 maxlength="25" id="produceHome" readonly></td>
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						value="<s:property value='#request.bug.bugDescribe'/>"></s:textarea>
				</td>
			</tr>
			<tr>
				<td colspan="4" class="ta_01" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						rows="3" value="<s:property value='#request.bug.resolveMethod'/>"></s:textarea>
					&nbsp;&nbsp;<span id=PResolve style="DISPLAY: ''"><input
						id="btnResolve" type="button" value=" 详细" name="btnResolve"
						value="<s:property value='#request.bug.btnResolve'/>"
						onclick="upload('7','13');" style="font-size: 12px; color: black;"></span></td>
			</tr>
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						value="<s:property value='#request.bug.bugReason'/>"></s:textarea>
				</td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						value="<s:property value='#request.bug.comment'/>"></s:textarea></td>
