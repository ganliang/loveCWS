...
<Script language="javascript">
	function check_null() {
		...
		document.Form1.action = "station/elecStationAction_update.do";
...
<body>
	<form name="Form1" method="post" id="Form1">
		<s:hidden name="stationID" value="%{#request.station.stationID}" />
		<br>
		<table cellSpacing="1" cellPadding="5" width="580" align="center"
			...
			<tr>
				...
				<td width="35%" class="ta_01" bgColor="#ffffff" height="30"><input
					name="useStartDate" type="text" size="20"
			...
			<tr>
				...
				<td width="85%" class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						cssStyle="width: 100%" rows="4"></s:textarea></td>
			</tr>
