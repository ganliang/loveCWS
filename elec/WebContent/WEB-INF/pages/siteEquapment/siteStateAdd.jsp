...
<script language="javascript">
	...
	function check_null() {
		...
		document.Form1.action = "station/elecStateAction_save.do";
	...
	function upload() {
		var str = "${pageContext.request.contextPath }/station/elecFileUploadAction_detail.do"
		...
		<table cellspacing="1" cellpadding="5" width="580" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><s:select
						...
						cssStyle="WIDTH: 155px" listKey="ddlCode" listValue="ddlName"></s:select>
				...
				<td class="ta_01" bgcolor="#ffffff"><s:select
						...
						headerValue="全部"></s:select> <font color="#FF0000">*</font></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input
					name="elecStation.stationCode" type="text" id="stationCode" size=20></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff"><input name="produceHome"
					type="text" size=20 maxlength="25" id="produceHome"></td>

			</tr>
			<tr>
				<td class="ta_01" align="center" bgcolor="#f5fafe">故障描述：</td>
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						name="bugDescribe" id="bugDescribe" cssStyle="WIDTH: 96%" rows="3"></s:textarea></td>
			</tr>
			<tr>
				<td colspan="4" class="ta_01" align="center"
					background="${pageContext.request.contextPath }/images/b-info.gif">
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						...
						rows="3"></s:textarea> &nbsp;&nbsp;<span id=PResolve
					style="DISPLAY: ''"><input id="btnResolve" type="button"
						value=" 详细" name="btnResolve" onclick="upload();"
			...
			<tr>
				...
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						name="bugReason" id="bugReason" cssStyle="WIDTH: 96%" rows="3"></s:textarea></td>
			</tr>
			<tr>
				<td class="ta_01" align="center" bgcolor="#f5fafe">备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					注：</td>
				<td class="ta_01" bgcolor="#ffffff" colspan="3"><s:textarea
						name="comment" id="comment" cssStyle="WIDTH: 96%" rows="3"></s:textarea></td>
